...
class MaterialGatePassController extends Controller
{
    ...
    public function sendOtpToCustomer($id)
    {
        try {
            ...
            $message = 'OTP is ' . $otp . ' for Material Gate Pass. Please show this SMS to Our Security to verify your material gate pass - TVS';

            if ($gate_pass_detail->vendor_contact_no) {
                $msg = sendOTPSMSNotification($gate_pass_detail->vendor_contact_no, $message);
            }
