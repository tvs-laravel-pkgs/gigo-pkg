...
class AlterTableJobOrderPartsAddFaultComplaintCols extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    {
        Schema::table('job_order_parts', function (Blueprint $table) {
            $table->dropForeign('job_order_parts_complaint_id_foreign');
            $table->dropForeign('job_order_parts_fault_id_foreign');
