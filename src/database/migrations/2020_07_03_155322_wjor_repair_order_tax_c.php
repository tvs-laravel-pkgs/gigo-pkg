...
class WjorRepairOrderTaxC extends Migration {
	/**
	 * Run the migrations.
	 *
	 * @return void
	 */
	public function up() {
		if (!Schema::hasTable('wjor_repair_order_tax')) {
			Schema::create('wjor_repair_order_tax', function (Blueprint $table) {
	...
	public function down() {
		Schema::dropIfExists('wjor_repair_order_tax');
	}
}
