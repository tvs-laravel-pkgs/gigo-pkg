...
<script type='text/javascript'>
	app.config(['$routeProvider', function($routeProvider) {
	    ...
	    when('/inward-vehicle/estimation-status/form/:job_order_id', {
	        template: '<inward-vehicle-estimation-status-form></inward-vehicle-estimation-status-detail-form>',
    ...
    var inward_vehicle_estimation_status_form_template_url = '{{asset($gigo_pkg_prefix.'/public/themes/'.$theme.'/gigo-pkg/inward-vehicle/estimation-status-detail-form.html')}}';
