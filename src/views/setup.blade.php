...
<script type="text/javascript">
    ...
    //LV Manin Types
    var lv_main_type_list_template_url = "{{asset($gigo_pkg_prefix.'/public/themes/'.$theme.'/gigo-pkg/lv-main-type/list.html')}}";
    var lv_main_type_form_template_url = "{{asset($gigo_pkg_prefix.'/public/themes/'.$theme.'/gigo-pkg/lv-main-type/form.html')}}";
    ...
    var material_gate_pass_card_list_template_url = "{{asset($gigo_pkg_prefix.'/public/themes/'.$theme.'/gigo-pkg/material-gate-pass/card-list.html')}}";
...
<script type='text/javascript'>
    ...
    var gate_pass_verify_view_template_url = '{{asset($gigo_pkg_prefix.'/public/themes/'.$theme.'/gigo-pkg/gate-pass/verify-view.html')}}';
...
<script type='text/javascript'>
	...
	//Vehicle Gate Passes
    var vehicle_gate_pass_table_list_template_url = "{{asset($gigo_pkg_prefix.'/public/themes/'.$theme.'/gigo-pkg/vehicle-gate-pass/list.html')}}";
    var vehicle_gate_pass_card_list_template_url = "{{asset($gigo_pkg_prefix.'/public/themes/'.$theme.'/gigo-pkg/vehicle-gate-pass/card-list.html')}}";
...
<script type='text/javascript'>
    ...
    var job_card_returnable_part_form_template_url = '{{asset($gigo_pkg_prefix.'/public/themes/'.$theme.'/gigo-pkg/job-card/returnable-part-form.html')}}';
    ...
    var job_card_pdf_template_url = '{{asset($gigo_pkg_prefix.'/public/themes/'.$theme.'/gigo-pkg/job-card/pdf.html')}}';
    ...
    //Job Card PDF
    var job_card_pdf_form_template_url = '{{asset($gigo_pkg_prefix.'/public/themes/'.$theme.'/gigo-pkg/job-card/pdf.html')}}';
...
<script type='text/javascript'>
    ...
    var warrantyJobOrderRequestTableList = '{{asset($gigo_pkg_prefix."/public/themes/".$theme."/gigo-pkg/warranty-job-order-request/table-list/template.html")}}';
